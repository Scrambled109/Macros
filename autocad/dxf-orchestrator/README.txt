...
If the script detects a bevel flag in a DXF, it queues that part for manual review. After background processing finishes, it opens every queued beveled part as a tab in the same full graphical AutoCAD application.
